...
export function signatureData(text, taskId, time) {
 ...
 */
export function signContent(signSecret, text, taskId, time) {
 ...
 */
export async function verifyContentSignature(yufuVerifyURL, signKeyId, data, signature, timeoutMs = 5000) {

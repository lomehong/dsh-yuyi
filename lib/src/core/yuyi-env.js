...
function loadEnvFile() {
    ...
    if (cached !== undefined && cachedMtimeMs === mtime)
        return cached;
    const out = {};
    try {
        if (existsSync(file)) {
...
/** 测试辅助：清空缓存（进程内）。 */
export function _clearYuyiEnvCache() {
    cached = undefined;
    cachedMtimeMs = -1;
}
/**
 ...
 */
export function loadSignKeyEnv(agentKind) {

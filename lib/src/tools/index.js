...
export function apply(ctx) {
    ...
    ctx.systemPrompt.section({
        ...
        text: 'The yuyi_* tools reach other agents through the hub relay. Address peers by their '
            ...
            + 'delivery lands on the task-anchored session when the message carries a taskId (the '
            + 'latest yuyi_task_attach wins), otherwise the earliest registered session; live sessions '
